...
namespace WeatherTracker.Classes
{
    public class Weather
    {
        ...
        ///// </summary>
        //public string LocationId = "2459115"; //"GRXX0019";

        ////private string baseUrl = "https://weather.yahooapis.com/forecastrss?&";
        ...
        //        //forecastUrl = baseUrl + "w=" + LocationId + "&u=c";
        //        forecastUrl = baseUrl + "id=" + LocationId;
        //        isMetric = true;
        //    }
        //    else {
        //        //forecastUrl = baseUrl + "w=" + LocationId + "&u=f";
        //        forecastUrl = baseUrl + "id=" + LocationId;
        //        isMetric = false;
        //    }
        ...
        //                float fSpeed = float.Parse( reader.GetAttribute( "speed" ) );
        //                fSpeed = (float) (fSpeed / 100.0);
        //                Wind.Speed = Convert.ToInt32( fSpeed );
        //            }
        //            if ( reader.Name.ToLower() == "yweather:atmosphere" ) {
        //                Atmosphere.Humidity = Convert.ToInt32( reader.GetAttribute( "humidity" ) );
        //                float fVisibility = float.Parse( reader.GetAttribute( "visibility" ) );
        //                fVisibility = (float) ( fVisibility / 100.0 );
        //                Atmosphere.Visibility = Convert.ToInt32( fVisibility );
        ...
        //                Geography.Latitude = Convert.ToDecimal( reader.Value );
        //            }
    ...
    public class Geography
    {
        ...
        public Geography( decimal latitude, decimal longitude ) {
            Latitude = latitude;
            Longitude = longitude;
        }
    }
